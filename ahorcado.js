...
var cadenas = ['ALERTA','PEACEMAKER','ACE','CASA','MONO','UNPATOALREVEZ','FLAN','COCO','DEADPOOL','LAMBOFGOD','PERRO','CELULAR','LIBRETA','COLCHON','ARMARIO','MEZA','QUEMAS','APLAUDA','ZAZA','YACUZA','MAFIARUZA','CARACORTADA'];
 ...
 {//inicia for e repetido
 	...
 	else
 	{
 			cadenas.push(palabra);
	 		 ...
	 		 alert("este es el de cadenas: "+ cadenas);
...
//	alert("Intentos: " +bandera);
	if(bandera==5)
	{
		alert("Has perdido, para volver a jugar preciona iniciar juego ");
	...
	{
		alert("Ganaste :D ,para volver a jugar preciona iniciar juego");
